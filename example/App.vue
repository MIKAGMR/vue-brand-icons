<template>
  <div id="app">
    <github
      ...
      fill="white"
      slug="mikagmr/vue-brand-icons">
    </github>
    <header class="header">
      <div class="container">
        <h1 class="hero-heading">vue-brand-icons</h1>
        <h2 class="desc">Simply beautiful open source brand icons as Vue functional components.</h2>
      </div>
    </header>
    <div class="container">
      ...
      <div class="sizing">
        ...
        <div class="sizes">
          <div
            ...
            <div class="size-icon">
              <adobe-icon :size="size"></adobe-icon>
            </div>
          </div>
        </div>
      </div>
...
export default {
  ...
  methods: {
    ...
    sizeExample(size) {
      return example
        .replace('1.5x', size)
        .replace(/ICON/g, 'AdobeIcon')
        .replace(/kebab-icon/g, 'adobe-icon')
    }
  },
  components: {
    ...icons,
